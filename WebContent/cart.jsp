...
<html>
	...
	<body>
		...
		<c:if test="${!empty cart.cartItems }">
							...
							<tbody>
								...
								<c:forEach items="${cart.cartItems }" var="entry">
									<tr class="active">
										...
										<td>
											<a href="javascript:;" onclick="delProFormCart('${entry.value.product.pid}')" class="delete">删除</a>
										</td>
									</tr>
								</c:forEach>
			...
			<c:if test="${empty cart.cartItems }">
				<div>
					<img alt="" src="${pageContext.request.contextPath }/images/cart-empty.png" width="500" height="500">
